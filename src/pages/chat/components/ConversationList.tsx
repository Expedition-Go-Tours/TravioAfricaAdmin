...
const accent = (type: "suppliers" | "customers") => {
  ...
  return {
    ...
    bg50slash: isSup ? "bg-green-50/70" : "bg-blue-50/70",
    bg100: isSup ? "bg-green-100/60" : "bg-blue-100/60",
    ...
    ring: isSup ? "focus-visible:ring-green-400" : "focus-visible:ring-blue-400",
